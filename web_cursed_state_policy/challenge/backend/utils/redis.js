...
export async function getCachedCSP() {
    ...
    if (cachedCSP) {
      ...
      // VULN: 043 - Insecure or unset HTTP headers - Content-Security-Policy
      // Se expone el nonce, y de ese modo en el XSS payload se puede poner el nonce para que el bot haga el request
